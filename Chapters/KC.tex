...
Table~\ref{table:ec} summarises \ac{EC} predicates which we use in our specification. 
...
Using roles we can define who will be \emph{empowered}, i.e.\ have the right, to provision and appropriate certain resources, according to \autoref{fig:psysex}.
