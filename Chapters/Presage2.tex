...
In this chapter we aim to determine a suitable platform for principled
...
result of this work, Presage2~\citep{Macbeth2014}. % TODO
...
\citet{Tobias2004} provide several useful general criteria and criteria specific for the modelling requirements of socio-technical systems:
...
It is for this reason that we decide to build on the framework of Presage and address its shortcomings in a new version, Presage2. We describe the design and implementation of this platform in the next section.
...
%We build on the same concepts in order to achieve the desired feature-set.
...
\autoref{alg:simloop} shows this simulation loop. Note object types and function names have been simplified for illustrative purposes. The \texttt{threadpool} object here extracts and executes step functions from objects submitted to it.
