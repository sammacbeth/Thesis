...
manual translation of \ac{EC} axioms for use with the JBoss Drools rule engine to
...
\item An experimental model of the management of participatory sensing as a knowledge commons, with which we validated the problem of supply of institutions, and identified that proper enfranchisement of users can be used to counter greed and self-interest in participatory-sensing.% incentivises good behaviour?? TODO
\end{itemize}
...
institutions, using our method of manually translating \ac{EC} into Drools rules, and
...
In our work we showed how Principle 1 can be addressed for a purely digital resource via
...
We have shown the performance improvements available through the manual translation
...
manual translation of \ac{EC} into Drools. However, we are able to use unit-testing
to provide confidence in the correctness of a manual translation. As the manual translation
...
We identified possible future work being a proof of the manual translation process
