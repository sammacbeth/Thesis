...
individually. First, we\hl{ }\marginpar{conclude}on the main topic of this thesis: the management of
participatory-sensing applications\hl{ }\marginpar{as}a knowledge commons. From both our analysis
...
there is also no sensing which can be done. Therefore the problem \hl{is}\marginpar{would be} neither a
...
in this case the allocation may be at the discretion of the provider of \hl{prediction}\marginpar{predictions},
