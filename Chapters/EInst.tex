...
Work on specification of constraints, or norms, for multi-
agent systems often focuses on the use of logics for specification. Logical
...
Prolog interpreter, as offered by the JPL project\footnote{http://www.swi-
prolog.org/packages/jpl/java\_api/index.html}; or with a pure Java Prolog
...
motions. Despite this, given the significant runtime with relatively small
...
We also present our implementation of a framework, and module library, Drools-
EInst, to enable the use of specifications translated with this method within
...
action for any session which is \emph{not} sitting (i.e.\ an infinite set of
...
Currently there are only a small number of modules implemented in the Drools-
