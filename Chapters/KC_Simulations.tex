...
To summarise, our model of an abstract reinforcement learning problem defines
that increasing rewards are tied to increasing information about playing the
game. The nature of this relationship is tied to the empirical results of a
single player N-Armed Bandit game using a Q-Learning strategy. We parametrise
