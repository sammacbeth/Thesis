...
factor equal to the maximum number of measurements possible in a single time-
step, \emph{collectedM} returns the set of measurements which have been
...
For the purposes of the presentation of results, we normalise these criteria
