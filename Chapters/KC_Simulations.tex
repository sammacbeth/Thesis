...
Note that as well as translating relevant axioms from the \ac{EC} specifications given previously, we also write some application specific rules directly into Drools.
